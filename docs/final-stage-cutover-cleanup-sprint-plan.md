...
**Дата завершения:** TBD
**Цель:** одним big-bang cutover-окном закрыxть всё, что осталось висеть после M2 / Stage 1 / Stage 2 α, привести систему в состояние «можно строить новые фичи (rusairegistry) без архитектурных компромиссов и shadow-таблиц».
