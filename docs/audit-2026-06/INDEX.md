...
| F-0122 | identity-status-sync | data-integrity | P1 | confirmed | open | findings/F-0122-identity-status-desync-blocks-login.md |

## Сводка по severity
- P0: 1 (F-0095 — chat IDOR, конструктор-guard не работает; ФЛАГ ВЛАДЕЛЬЦУ 2026-06-09)
- P1: 26 (F-0001, F-0002, F-0007, F-0013, F-0014, F-0015, F-0020, F-0021, F-0031, F-0034, F-0035, F-0036, F-0042, F-0052, F-0061, F-0074, F-0077, F-0088, F-0091, F-0092, F-0099, F-0106, F-0110, F-0113, F-0116, F-0122)
...
- **ИТОГО: 122 находки (1 P0 + 26 P1 + 61 P2 + 34 P3) по 37 потокам (TIER 1-4 закрыты; +6 из аудита свитчера 2026-06-22; +F-0122 identity-status-sync 2026-07-22)**

## Опровергнуто при верификации (не залогировано)
- «disabled-юзер аутентифицируется в rusaifin» — ОПРОВЕРГНУТО: все 237 `auth:oauth`-роутов несут `UserIsNotDisabled` (дефект валиден только для sklad → F-0026). NB: обратная сторона — рассинхрон `identity_users.status`, который блокирует **активного** юзера — реальна и залогирована как F-0122.
